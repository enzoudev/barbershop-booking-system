...
import { EnvelopeSimpleIcon, EyeIcon, UserIcon } from "@phosphor-icons/react"
     ...
     return (
        <div className="bg-[#181818] min-h-screen flex items-center justify-center">
            ...
            <div className="form-login flex flex-col items-center w-1/2 mt-50 gap-10 h-full">
                ...
                <h2 className=" text-[20px] text-black font-black tracking-tight border-[#020618]">Se registre.</h2>
